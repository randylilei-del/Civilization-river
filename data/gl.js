...
'秦': [
 { a:-221, b:-210, k:'tech', t:['标准化工程','Standardization'], d:['文字统一为小篆;统一度量衡的诏书铸刻在铜权铁量上发往全国——今天博物馆里的秦权、秦量上还能读到这道四十字诏文;车轨定为六尺,秦律通行各郡。','The script was fixed as small seal; the edict unifying weights and measures was cast onto bronze weights and iron measures and sent across the realm — the forty-character text is still legible on Qin weights in museums today; axle width was set at six chi, and Qin law ran in every commandery.'] },
 { a:-220, b:-210, k:'tech', t:['驰道、直道与灵渠','Highways and the Lingqu canal'], d:['前 220 年起以咸阳为中心修驰道通向六国故地,《汉书》说路宽五十步;前 212 年蒙恬修直道,从九原到云阳七百多公里,陕北高原上至今看得见路基;前 214 年史禄凿成灵渠,把湘江与漓江接通,长江与珠江两大水系第一次连成一片。','From 220 BC imperial highways radiated from Xianyang into the old six kingdoms — fifty paces wide, says the Book of Han; in 212 BC Meng Tian built the Straight Road, 700-odd km from Jiuyuan to Yunyang, its roadbed still visible on the northern Shaanxi plateau; in 214 BC the engineer Shi Lu finished the Lingqu canal, joining the Xiang and Li rivers and linking the Yangtze and Pearl river systems for the first time.'] },
 { a:-221, b:-208, k:'art', t:['骊山陵与兵马俑','The First Emperor\'s tomb and its terracotta army'], d:['始皇陵动用七十万刑徒修了三十多年;陵东一公里的三个陪葬坑里站着约八千件真人大小的陶俑,面孔各不相同,兵种与军阵一如实战;1980 年出土的两乘彩绘铜车马按真车一半比例制成,每乘零件三千多个。这一切在 1974 年才被打井的农民重新挖出来。','Seven hundred thousand convict labourers worked on the tomb for over thirty years; in three pits a kilometre to its east stand some 8,000 life-size terracotta soldiers, no two faces alike, drawn up by arm and formation as for battle; two painted bronze chariots unearthed in 1980 are half-scale replicas of real ones, each of 3,000-odd parts. All of it came back to light only in 1974, when farmers digging a well struck the first fragments.'] },
 { a:-221, b:-207, k:'thought', t:['律令落到县里:睡虎地与里耶秦简','Law reaching the county: the Shuihudi and Liye slips'], d:['秦法怎么落到一个县,两千年后从地下读到了原件:1975 年湖北云梦睡虎地一座小吏的墓里出土 1100 多枚竹简,抄的是秦律条文与判案手册;2002 年湖南里耶一口古井里出土 3.6 万余枚简牍,是迁陵县衙的日常档案——户口、粮仓、驿传,还有一块写着九九乘法口诀的木牍。','How Qin law actually reached a county can be read today from the originals: in 1975 the tomb of a minor official at Shuihudi, Hubei yielded 1,100-odd bamboo slips copying Qin statutes and a casebook for judging; in 2002 an old well at Liye, Hunan gave up more than 36,000 slips — the day-to-day files of Qianling county: household registers, granary accounts, post-station records, even a wooden board with the nine-times multiplication table.'] },
],
'东汉': [
