...
'阿拉伯哈里发': [
 ...
 { a:800, b:1000, k:'tech', t:['代数与天文','Algebra & astronomy'], d:['花剌子米的书名 al-jabr 后来变成了 algebra(代数),他的名字则变成了 algorithm(算法);巴格达与马拉盖的天文台连年观测,编出的星表精度在此后几百年里没人超过。','The title of al-Khwarizmi\'s book, al-jabr, became the word algebra, and his own name became algorithm; the observatories at Baghdad and Maragha observed year after year and produced star tables no one bettered for centuries.'] },
...
'美国': [
 ...
 { a:1945, b:1973, k:'econ', t:['战后繁荣','Postwar boom'], d:['战后二十多年里,美国一国的产出接近全世界一半,普通工人买得起房和车,「中产」第一次成为社会的多数;布雷顿森林体系把各国货币钉住美元、美元钉住黄金,美国由此成为世界货币的锚。','For twenty-odd years after the war the United States produced close to half the world\'s output, ordinary workers could afford a house and a car, and the middle class became the majority for the first time; Bretton Woods pegged other currencies to the dollar and the dollar to gold, making America the anchor of world money.'] },
...
'印加': [ { a:1440, b:1530, k:'tech', t:['道路与农业工程','Roads & terraces'], d:['三万多公里的驿道翻越安第斯山,沿途设驿站,接力跑的信使一天能传八百公里的消息;梯田把陡坡改成能耕的平台,配上引水渠,在四千米的高处种出了粮食。','Over thirty thousand kilometres of road crossed the Andes with relay posts along them, and running messengers could carry news eight hundred kilometres in a day; terraces turned steep slopes into workable ground and, with irrigation channels, grew crops four thousand metres up.'] } ],
...
'韩国': [
 { a:1962, b:1997, k:'econ', t:['汉江奇迹','Miracle on the Han'], d:['1960 年代初韩国还比多数非洲国家穷,三十五年后成了造船与半导体的强国。做法是把有限的资金押在几个财阀身上、逼它们出口挣外汇,代价是长期的威权统治与 1997 年那场债务危机。','In the early 1960s Korea was poorer than most African countries; thirty-five years later it led the world in shipbuilding and semiconductors. It did this by betting scarce capital on a few conglomerates and forcing them to export — at the cost of long authoritarian rule and the debt crisis of 1997.'] },
...
'德意志': [
 ...
 { a:1950, b:1990, k:'econ', t:['经济奇迹','The Wirtschaftswunder'], d:['战败时城市成片是瓦砾,二十年后西德成了欧洲最大的工业国。靠的是马歇尔计划的启动资金、被炸毁反而得以更新的设备,以及把大批技术工人重新组织起来的双元制学徒训练。','Its cities were fields of rubble at the defeat; twenty years later West Germany was Europe\'s largest industrial economy — on Marshall Plan capital, on plant that had to be rebuilt new because it had been bombed flat, and on an apprenticeship system that put its skilled workers back to work.'] } ],
...
'马六甲及诸苏丹国': [ { a:1400, b:1511, k:'econ', t:['香料转口港','The spice entrepot'], d:['葡萄牙人记下这里的码头上同时听得到八十四种语言。马六甲海峡是印度洋与南海之间唯一的窄口,季风一年换两次向,船必须在这里等风、卸货、转手——港口因此靠收停泊税与转口费吃饭。','The Portuguese recorded eighty-four languages spoken on its wharves. The strait is the only narrow gate between the Indian Ocean and the South China Sea, and with the monsoon reversing twice a year ships had to wait here for the wind, unload and trade on — so the port lived on anchorage dues and transhipment.'] } ],
