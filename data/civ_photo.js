/* ---------- 文明照片(v204,Ray 拍板:先城市后文明,不用 AI 图、不用人像) ----------
   ...
   覆盖不到的文明留空——**名单 v382 起搬进 audit.js 的 PHOTO_NA(规则 88)由机器查**,
   因为它只写在这里的时候,拆带拆出来的新带会静默加入留空(2026-09-06 盘点发现无照片 17 条而名单只有 12 条,
   多出的米诺斯/中王国埃及/高丽/幕府时代/近现代日本全是拆带的另一半没继承照片,同批已补齐)。留空=v209 的 11 条+喀布尔沙希——维基条目无首图,Commons 搜索也没有可用实物照;v209 时点 11 条:匈奴、柔然、匈人、嚈哒、准噶尔、俄国治下中亚、西晋、渤海国、卡涅姆·博尔努、加纳帝国、拉皮塔——
...
const CIV_PHOTO = {
'米诺斯': [
 { f:'Knossos_bull_leaping_fresco.jpg', h:'d/d8', t:['克诺索斯的跳牛壁画','the bull-leaping fresco from Knossos'], by:'Gsimonov', lic:'CC0' },
],
'中王国埃及': [
 { f:'White_Chapel.jpg', h:'3/32', t:['辛努塞尔特一世的白色小神殿','the White Chapel of Senusret I'], by:'Markh', lic:'CC BY-SA 3.0' },
],
'高丽': [
 { f:'Goryeo_Celadon.jpg', h:'b/b1', t:['青瓷象嵌云鹤纹梅瓶','a Goryeo celadon vase inlaid with cranes and clouds'], by:'Korea history', lic:'CC BY-SA 3.0' },
],
'幕府时代': [
 { f:'230128_Kamakura_Daibutsu_Japan04s3.jpg', h:'c/cf', t:['镰仓大佛','the Great Buddha of Kamakura'], by:'663highland', lic:'CC BY-SA 4.0' },
],
'近现代日本': [
 { f:'Shinkansen_Series0_R67_JNRcolor.jpg', h:'9/90', t:['0 系新干线','a 0 Series Shinkansen train'], by:'ナダテ', lic:'CC BY 3.0' },
],
'迈锡尼': [
