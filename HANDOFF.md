...
- **v13、v14 已 push**(origin/main = `690ee00`);**v15 已 commit,待 Ray 手动 push**
- 数据规模:112 个文明 · 787 条大事记 · 154 段鼎盛区间(覆盖 104/112)· 22 个交流事件 · 10 条传播轨迹
- 功能全景见 docs/CHANGELOG.md(v0-v15);设计理由见 docs/DESIGN.md;改数据前必读 docs/DATA.md
...
4. **其余七条泳道还没做过断流扫描** —— v15 只扫了草原·中亚就挖出四段共 775 年空白。扫描方法已写进 docs/DATA.md「常见操作」第一条。**这是目前性价比最高的下一步**:很可能还有别的泳道也在断流,而断流比"某个文明大事记少"严重得多
