...
- **v13、v14 已 push**(origin/main = `690ee00`);**v15、v16 已 commit,待 Ray 手动 push**
- 数据规模:112 个文明 · 787 条大事记 · 154 段鼎盛区间(覆盖 104/112)· 156 条古地名今址 · 22 个交流事件 · 10 条传播轨迹
- 功能全景见 docs/CHANGELOG.md(v0-v16);设计理由见 docs/DESIGN.md;改数据前必读 docs/DATA.md
