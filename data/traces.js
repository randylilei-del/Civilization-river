...
{ g:'people', n:['班图大迁徙','The Bantu Expansion'], stops:[
  ...
  { y:400, l:'af', t:['南部非洲','Southern Africa'], d:['约 400 年前后抵达今南非东部——今天撒哈拉以南的多数语言,都属于班图语族。','By about 400 CE they reach today\'s eastern South Africa — most languages south of the Sahara belong to the Bantu family.'] },
] },
{ g:'people', n:['突厥人的西迁','The Turkic Migrations'], stops:[
  ...
  { y:1453, l:'me', t:['奥斯曼收尾','The Ottoman finale'], d:['这场三千公里的迁徙以奥斯曼人攻下君士坦丁堡收尾——「土耳其」这个国名里,至今装着「突厥」。','The 3,000-km migration ends with the Ottomans taking Constantinople — \'Turkey\' still carries the name \'Türk\'.'] },
] },
{ g:'people', n:['大西洋奴隶贸易','The Atlantic Slave Trade'], stops:[
  ...
  { y:1600, l:'am', t:['种植园','The plantations'], d:['他们被卖到加勒比与巴西的甘蔗园、棉田里做苦工;美洲积起的财富里,有相当一部分是用他们的苦难换来的。','Sold into the sugar and cotton fields of the Caribbean and Brazil — much of the New World\'s wealth was made from their suffering.'] },
  { y:1807, l:'eu', t:['废奴','Abolition'], d:['英国率先立法禁止奴隶贸易,数十年内各国相继跟进;被带走的人的后代已在美洲扎根,他们的音乐与文化成了美洲底色的一部分。','Britain outlaws the trade in 1807 and others follow within decades; the descendants of the taken have put down roots, their music and culture now part of the Americas themselves.'] },
] },
...
{ g:'institutions', n:['律令与科举的东亚之旅','Law Codes and Exams in East Asia'], stops:[
  { y:653, l:'ea', t:['唐:律令与科举','Tang: code and examination'], d:['《唐律疏议》定稿,科举全面推行——一套「国家该怎么组织」的完整方案在唐朝成形。','The Tang Code is finalised and the examinations take hold — a complete blueprint for organising a state.'] },
...
{ g:'institutions', n:['罗马法的旅行','The Journey of Roman Law'], stops:[
  { y:-450, l:'eu', t:['十二表法','The Twelve Tables'], d:['罗马人把法律刻在十二块铜表上立于广场——规则写下来、人人可看,是它走向法治的第一步。','Rome posts its laws on twelve bronze tables in the Forum — written rules that anyone can read.'] },
...
{ g:'goods', n:['丝绸','Silk'], stops:[
  ...
  { y:100, l:'eu', t:['罗马的丝绸热','Rome\'s silk fever'], d:['罗马贵族为丝绸一掷千金,元老院一度嫌它太费钱、太轻薄想要禁穿——没有禁住。','Roman elites paid fortunes for it; the Senate grumbled that it was ruinous and immodest, and failed to ban it.'] },
