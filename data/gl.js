...
'北欧诸王国': [
  ...
  { a:1429, b:1814, k:'econ', t:['厄勒海峡的过路税','The Sound Dues'], d:['进出波罗的海的船都要过这道海峡,丹麦在两岸架炮收税,长期是王室最大的一笔进项。','Every ship into or out of the Baltic had to pass the Sound, where Denmark mounted guns on both shores and collected a toll — for long stretches the crown\'s largest single revenue.'] } ],
'海湾诸邦': [
