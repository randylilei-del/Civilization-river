...
'伐卡塔卡与德干诸国': [
  { a:460, b:490, k:'art', t:['阿旃陀的壁画','The paintings at Ajanta'], d:['第二期洞窟在哈里塞纳手里完成,今天画册上那些脸大多来自这一批;洞窟后来被森林盖住,1819 年才被打猎的军官偶然发现。','The second phase was finished under Harishena — most of the faces in the art books come from it. Forest swallowed the caves, and they were found again only in 1819 by officers out hunting.'] },
  { a:390, b:450, k:'thought', t:['铜板上的赠地文书','Land grants on copper'], d:['这段德干史几乎没有史书,靠的是刻在石头与铜板上的敕令;普拉巴瓦蒂古普塔摄政时发出的铜板,用的是她自己的名字。','Almost no chronicle survives from this age; what is known rests on edicts cut in stone and copper. The plates issued during Prabhavatigupta\'s regency carry her own name.'] },
],
'笈多王朝': [
...
'帕查卡马克与中部海岸': [
  { a:600, b:1470, k:'thought', t:['海岸上最大的神谕所','The great oracle of the coast'], d:['各地的人长途赶来求问收成、疾病与战争;求过的人回去还供养它,远处因此有一批分庙。','People travelled far to ask it about harvests, sickness and war, and went on supporting it afterwards — so it kept branch shrines at a distance.'] },
  { a:200, b:1470, k:'econ', t:['朝圣也是一门生意','Pilgrimage as an economy'], d:['神庙周围长出作坊、客舍与市集;遗址里挖出过来自厄瓜多尔的海菊蛤壳,走了上千公里运来。','Workshops, lodgings and markets grew around the sanctuary; Spondylus shell from Ecuador, carried over a thousand kilometres, turns up in the excavations.'] },
],
...
'秦': [
 { a:-221, b:-210, k:'tech', t:['标准化工程','Standardization'], d:['文字统一为小篆;统一度量衡的诏书铸刻在铜权、铁权和量器上发往全国——今天博物馆里的秦权、秦量上还能读到这道四十字诏文;车轨定为六尺,秦律通行各郡。','The script was fixed as small seal; the edict unifying weights and measures was cast onto bronze and iron weights and onto measuring vessels and sent across the realm — the forty-character text is still legible on Qin weights in museums today; axle width was set at six chi, and Qin law ran in every commandery.'] },
 { a:-220, b:-210, k:'tech', t:['驰道、直道与灵渠','Highways, the Straight Road and the Lingqu canal'], d:['前 220 年起以咸阳为中心修驰道通向六国故地,《汉书》说路宽五十步;前 212 年蒙恬开修直道,从九原到云阳七百多公里,陕北高原上至今看得见路基;前 214 年史禄凿成灵渠,把湘江与漓江接通,长江与珠江两大水系第一次连成一片。','From 220 BC imperial highways radiated from Xianyang into the old six kingdoms — fifty paces wide, says the Book of Han; in 212 BC Meng Tian began the Straight Road, 700-odd km from Jiuyuan to Yunyang, its roadbed still visible on the northern Shaanxi plateau; in 214 BC the official Shi Lu finished the Lingqu canal, joining the Xiang and Li rivers and linking the Yangtze and Pearl river systems for the first time.'] },
 { a:-221, b:-208, k:'art', t:['骊山陵与兵马俑','The First Emperor\'s tomb and its terracotta army'], d:['始皇陵动用七十万刑徒修了三十多年;陵东一公里半的三个陪葬坑里站着约八千件真人大小的陶俑,面孔各不相同,兵种与军阵一如实战;1980 年出土的两乘彩绘铜车马按真车一半比例制成,每乘零件三千多个。俑坑是 1974 年打井的农民偶然挖到的。','Seven hundred thousand convict labourers worked on the tomb for over thirty years; in three pits a kilometre and a half to its east stand some 8,000 life-size terracotta soldiers, no two faces alike, drawn up by arm and formation as for battle; two painted bronze chariots unearthed in 1980 are half-scale replicas of real ones, each of 3,000-odd parts. The pits came to light only in 1974, when farmers digging a well struck the first fragments.'] },
 { a:-221, b:-207, k:'thought', t:['律令落到县里:睡虎地与里耶秦简','Law reaching the county: the Shuihudi and Liye slips'], d:['秦法怎么落到一个县,两千年后从地下读到了原件:1975 年湖北云梦睡虎地一座小吏的墓里出土 1100 多枚竹简,主要是秦律条文与判案手册;2002 年湖南里耶一口古井里出土 3.6 万余枚简牍,是迁陵县衙的日常档案——户口、粮仓、驿传,还有一块写着九九乘法口诀的木牍。','How Qin law actually reached a county can be read today from the originals: in 1975 the tomb of a minor official at Shuihudi, Hubei yielded 1,100-odd bamboo slips, mostly Qin statutes and a casebook for judging; in 2002 an old well at Liye, Hunan gave up more than 36,000 slips — the day-to-day files of Qianling county: household registers, granary accounts, post-station records, even a wooden board with the nine-times multiplication table.'] },
],
'东汉': [
...
'扎格维王朝': [
  { a:1180, b:1230, k:'art', t:['把圣城凿进岩石','A holy city cut into rock'], d:['先在岩床上凿深沟围出一个方块,再从上往下把里面掏空:门窗、柱子、屋顶全是原岩,没有一块砖石是搬来的;隧道与排水沟把十一座教堂连在一起。','Trenches were cut to isolate a block of bedrock, which was then hollowed downward from above: doors, columns and roof are all living rock and not one stone was carried in. Tunnels and drains link the eleven churches.'] },
  { a:1150, b:1270, k:'thought', t:['被包围起来的古老教会','An ancient church, encircled'], d:['周围普遍伊斯兰化之后,高原上的基督教仍旧延续,守安息日、行割礼、用格厄兹语做礼拜;欧洲流传的「祭司王约翰」传说后来被安到了这个国家头上。','As the surrounding countries turned Muslim, Christianity continued on the plateau — keeping the Sabbath, practising circumcision, worshipping in Geez. Europe\'s legend of Prester John was eventually attached to this kingdom.'] },
],
'马里帝国': [
