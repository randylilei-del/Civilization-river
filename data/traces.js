...
{ g:'beliefs', n:['消失在东方的教','The faiths that vanished in the East'], stops:[
  { y:240, l:'me', t:['摩尼在波斯开教','Mani starts preaching in Persia'], d:['摩尼是个波斯人,他说自己是最后一位先知,把祆教、基督教、佛教的说法都收进自己的书里。他还亲手给经书画插图,这是有意的办法:不识字的人也跟得上。萨珊王沙普尔一世准他传教,换了一位王风向就变了,他约在 276 年死在狱中。','Mani was a Persian who said he was the last of the prophets, and he gathered into his own books what Zoroastrians, Christians and Buddhists taught. He painted pictures to go with them, and did it on purpose: someone who could not read could still follow. King Shapur I let him preach; under the next king the wind changed, and he died in prison around 276.'] },
  { y:431, l:'me', t:['一场公会议之后,一支教会往东走','A council, and a church that went east'], d:['431 年以弗所公会议判聂斯脱里的说法不对。持相近说法的教会在波斯境内落了脚,用叙利亚语做礼拜,自称「东方教会」——后人习惯叫它「聂斯脱里派」,它自己不这么叫。它不归罗马也不归君士坦丁堡管,这在波斯反倒是好事:波斯王要防的是听罗马号令的人,而这个教会谁的号令都不听。','In 431 the council at Ephesus ruled that Nestorius was wrong. A church holding a view close to his settled inside Persia, worshipped in Syriac and called itself the Church of the East — later ages label it Nestorian; that was never its own name for itself. Answering to neither Rome nor Constantinople told in its favour in Persia: what the Persian king had to guard against was subjects who took orders from Rome, and this church took orders from nobody there.'] },
  { y:635, l:'ea', t:['阿罗本走到长安','Alopen reaches Chang\'an'], d:['一个叫阿罗本的教士带着经书走到长安。唐太宗派宰相到城西迎他,准他在城里译经、盖寺;这一支在中国的名字后来定成「景教」。这段经过主要靠 781 年立的那块碑记着,传世史书里只有零星几句能对上——这也是它后来那么容易被忘掉的原因之一。','A cleric named Alopen came to Chang\'an with his books. The Tang emperor sent his chief minister to meet him west of the city and let him translate and build; the name this branch took in China was Jingjiao, the luminous teaching. Nearly all we know of the episode comes from a stone put up in 781, with only a line or two in the standard histories to match it — part of why it was so easy to forget later.'] },
  { y:762, l:'st', t:['回鹘可汗把它定成国教','A khagan makes it the state faith'], d:['回鹘可汗在洛阳听摩尼教僧人讲道,回去把它定成全国的教。这件事对中原的影响是:唐朝刚靠回鹘的骑兵平定过一场大乱,欠着人情,于是从 768 年起,长安、洛阳、扬州、荆州陆续准许建摩尼寺。这几座寺是替盟友开的,不是替信徒开的——八十年后正是这一点要了它的命。','The Uyghur khagan heard Manichaean teachers at Luoyang and made their faith the faith of his whole state. What that meant inside China: the Tang had just put down a great rebellion with Uyghur cavalry and owed a debt, so from 768 on, Manichaean temples were permitted at Chang\'an, Luoyang, Yangzhou and Jingzhou. Those temples were opened for an ally, not for believers — and eighty years later that was what killed them.'], p:0 },
  { y:781, l:'ea', t:['一块碑,两种文字','One stone, two scripts'], d:['这一年长安立起「大秦景教流行中国碑」:汉文正文旁边是叙利亚文,碑的下端与两侧列着七十多位教士的名字,两种文字各写一遍。碑在明朝末年从土里挖出来,消息传到欧洲,有人一口咬定是耶稣会士伪造的。今天没人这么说了——想知道景教在中国是什么样子,大半还得从这块碑上看。','This year a stone went up at Chang\'an recording the spread of the luminous teaching from Daqin: Chinese text flanked by Syriac, with some seventy clergy named along the foot and the sides, each name written out in both scripts. It was dug up again at the end of the Ming, and when word reached Europe some flatly declared it a Jesuit forgery. Nobody says that now — and most of what can be said about this church in China still has to be read off that stone.'], p:2 },
  { y:845, l:'ea', t:['会昌年间一并禁掉','Swept away in the Huichang years'], d:['845 年唐武宗下令拆寺,主要冲着佛教;诏书末尾还有一句,把三千多名「大秦穆护祆」的教士一并勒令还俗(这句话怎么断、说的到底是哪几家,学者读法不一)。摩尼教两年前已经先挨过一刀:840 年回鹘汗国被黠戛斯打散,靠山没了,朝廷随即查禁摩尼寺。佛教后来缓了过来,这几家没有。','In 845 Emperor Wuzong ordered the monasteries pulled down, aiming mainly at the Buddhists; a line at the end of the edict sent three thousand more clergy — of Daqin, of the magi, of the Zoroastrians, depending how the phrase is parsed, and scholars differ — back to lay life as well. Manichaeism had taken its blow two years earlier: in 840 the Kyrgyz broke up the Uyghur khaganate, the protector was gone, and the court shut the Manichaean temples at once. Buddhism recovered. These did not.'] },
  { y:1339, l:'ea', t:['泉州的十字架,草庵的石像','Crosses at Quanzhou, a Mani in stone'], d:['元朝把海路重新打开,这两个教又回来了一阵。泉州出土过几十方元代基督徒的墓碑——当时官府管他们叫「也里可温」——碑上的十字架底下常常托着一朵莲花或一片祥云,是两套图案长在了一块石头上。晋江华表山的草庵里,1339 年在崖壁上凿出一尊「摩尼光佛」的坐像,那是今天世界上唯一还立着的摩尼教寺庙。','The Yuan reopened the sea routes and both faiths came back for a while. Dozens of Christian gravestones of Yuan date have been dug up at Quanzhou — the government of the day called these people yelikewen — and the cross on them commonly rests on a lotus or a cloud, two sets of images grown together on one slab. In the hermitage of Cao\'an on Huabiao hill at Jinjiang, a seated Mani, titled the Buddha of Light, was cut from the cliff in 1339; it is the only Manichaean temple left standing anywhere in the world.'] },
  { y:1498, l:'sa', t:['在中国断了,在别处没断','Broken in China, not everywhere'], d:['1498 年葡萄牙船到印度西南的马拉巴尔海岸,发现那里早就有基督徒,用叙利亚语做礼拜,自称是使徒托马斯传下来的——正是东方教会的一支,今天还在。摩尼教没有这个运气:它是真的没了。要读它自己的经书,只能去敦煌与吐鲁番的残卷里读,还有一批是从埃及沙漠里挖出来的科普特文抄本。','When Portuguese ships reached the Malabar coast of south-west India in 1498 they found Christians already there, worshipping in Syriac and tracing themselves to the apostle Thomas — a branch of that same Church of the East, and still there today. Manichaeism had no such luck; it is genuinely gone. To read its own scriptures you have to go to the fragments from Dunhuang and Turfan, and to a body of Coptic manuscripts dug out of the Egyptian desert.'], p:1 },
] },
];
